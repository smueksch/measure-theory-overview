...
\newenvironmentx{trick}[2][\empty] {

    \newcommand{\Title}{Trick}
...
\begin{definition}{5.1}{Almost Sure Convergence}
    ...
    Let $(f_n)_{n=1}^{\infty}$ be $\CalF$-measurable functions. The $f_n$ are said to \emph{converge almost surely} to a \emph{$\mu$-a.s. finite} $f: \Omega \to \overline{\mathbb{R}}$ as $n \to \infty$ if there exists an $A \in \CalF$ s.t. $P(A) = 0$ and
...
\begin{trick}{}{$\mu$-Almost Everywhere Finite}
...
\begin{trick}{}{Almost Surely Finite}
...
\begin{trick}{}{Function As Integral}
